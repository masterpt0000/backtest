...
# ── Pine v6 "Market Lateral RSI" (bott72341): length_ema=100, length_ema2=1, length_ema3=1000,
#    dif_obv_norm = dif_obv / sma(volume,1000), filter_trend inclui dif_pct2 ±0.8
...
def strategy(self, df):
    ...
    # Lógica de contagem EMA2 flat (saída por lateralização) — Pine: só com posição aberta
    ...
    # Pine: get_out = (lower_6 > close or upper_6 < close) and not filter_trend
    ...
    # ************************************* Strategies first Entry (Market Lateral RSI — Pine) *************************************
